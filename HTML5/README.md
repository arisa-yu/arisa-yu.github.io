...
it went pretty well! it felt like a simplier version of HTML/CSS, but i think having that foundation from the web design class helped since it made everything feel more familiar and intutitive. the only small problem i had was that i kept adding a space in between the brackets and parentheses when i was trying to link something, and was wondering why it wasn't working. overall, it just kind of felt like i was sending a text to a friend or writing an email, so it was pretty enjoyable! 
